...
public class LegacyWebTableSteps {
    ...
    public void tableContainsExactlyFollowingData(String page, String tableName, ExamplesTable data) {
        ...
        verifyTableContainsExactlyFollowingData(
            convertHtmlRenderer(WebSteps.getCurrentSetting().getHtmlRenderer()),
            page,
            tableName,
            expectedTableData,
            true);
    ...
    private HtmlRenderer convertHtmlRenderer(org.jbehavesupport.core.web.WebTableSteps.HtmlRenderer htmlRenderer) {
        return HtmlRenderer.valueOf(htmlRenderer.name());
    }
